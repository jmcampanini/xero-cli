...
func TestDocumentFilters(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"bank quoted reference", []string{"bank-transactions", "list", "--account", "090", "--month", "2024-02", "--reference", `"quoted"`}, "BankTransactions", period + "&&" + account + `&&Status=="AUTHORISED"&&Reference=="""quoted"""`, "", nil},
		{"bank literal backslash", []string{"bank-transactions", "list", "--account", "090", "--month", "2024-02", "--reference", `a\n\`}, "BankTransactions", period + "&&" + account + `&&Status=="AUTHORISED"&&Reference=="a\n\"`, "", nil},
		{"bank reference expression is literal", []string{"bank-transactions", "list", "--account", "090", "--month", "2024-02", "--reference", `"||true||Reference=="`}, "BankTransactions", period + "&&" + account + `&&Status=="AUTHORISED"&&Reference=="""||true||Reference=="""`, "", nil},
